        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todoApp/signupuser.html',
                              {'form': UserCreationForm(), 'error': 'Username already taken. Please try with different username'})
        else:
...
def createtodos(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todoApp/createtodos.html', {'form': TodoForm(), 'error':'Give Proper Inputs'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todoApp/viewtodo.html', {'todo': todo, 'form': form, 'error':'Please give valid Inputs'})
